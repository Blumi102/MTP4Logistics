## 6.7 Evaluation Example: PLC-Based Emulation
...
The MLS serves two packaging processes — bag filling and octabin filling — executed concurrently. [Figure 6.27](#figure-627-pLC-based-emulation-of-a-modular-logistics-system-evaluation-example-3) shows the system layout, transport nodes, and possible material flows.

##### Figure 6.27: PLC-Based Emulation of a Modular Logistics System (Evaluation Example 3)
