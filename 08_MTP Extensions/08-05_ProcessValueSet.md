## 8.5 MTP Extension of the ProcessValueSet
...
### 8.5.2 DataAssembly definitions
#### Specification of the System Unit Class StructProcessValueIn
*SUC StructProcessValueIn* ([Table 8.39](#table-839-dataassembly-definition-of-suc-structprocessvaluein)) is used by a LEA to access the value of a variable with a structured data type from another LEA.

##### Table 8.39: DataAssembly definition of *SUC StructProcessValueIn*
...
*SUC ArrayProcessValueIn* ([Table 8.40](#table-840-dataassembly-definition-of-suc-arrayprocessvaluein)) is used by a LEA to access a value at a specific position of an array in another LEA.

##### Table 8.40: DataAssembly definition of *SUC ArrayProcessValueIn*
...
*SUC OutputElement* ([Table 8.41](#table-841-dataassembly-definition-of-suc-outputelement)) is an abstract interface from which specific process-value outputs of different data types can be derived. The DataAssembly definition itself serves only an organizational purpose and provides a variable for transmitting a *Worst Quality Code (WQC)*.

##### Table 8.41: DataAssembly definition of *SUC OutputElement*
...
*SUC ArrayProcessValueOut* ([Table 8.42](#table-842-dataassembly-definition-of-suc-arrayprocessvalueout)) is used by a LEA to provide the values of a LEA-internal array to another LEA.

##### Table 8.42: DataAssembly definition of *SUC ArrayProcessValueOut*
