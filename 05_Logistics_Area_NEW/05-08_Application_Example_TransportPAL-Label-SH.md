...
To illustrate the concepts described in this chapter for logistics area automation, this section presents an exemplary application of the transport concept. Therefore, the example already introduced in [Section 5.1.2](05_Logistics_Area.md#512-working-principle) is used. A push transport from a PAL to a SH LEA is carried out with a LABEL LEA visited along the way. [Figure 5.16](#figure-516-example-of-a-push-transport-from-a-palletizer-via-a-labeling-unit-to-a-stretch-hood-machine) shows the LEAs and their transport nodes.

##### Figure 5.16: Example of a Push Transport from a Palletizer via a Labeling Unit to a Stretch Hood Machine
![Example of a Push Transport from a Palletizer via a Labeling Unit to a Stretch Hood Machine](../06_Application_Examples/images/Transport_Beispiel.svg)

### 5.8.1 LEA Integration
As the basis for carrying out the transport process, the MTPs of the three LEAs are imported into the LEA Management of the Transport Management in accordance with the mechanisms described in [Section 5.5.2](05-05_Logistics_Equipment_Assemblies.md#552-integration-of-leas-into-the-transport-management), *Transport Proxies* are generated, and these are connected to the LEA transport nodes. [Figure 5.17](#figure-517-integration-of-leas-into-a-transport-management-system) shows the process of integrating the three LEAs; [Figure 5.18](#figure-518-integration-of-all-transport-nodes-of-leas-into-a-transport-management-system) shows the process of integrating all transport nodes available in the LEAs.[^1]

##### Figure 5.17: Integration of LEAs into a Transport Management System
![Integration of LEAs into a Transport Management System](../06_Application_Examples/images/00_Integration_LEA.svg)

##### Figure 5.18: Integration of All Transport Nodes of LEAs into a Transport Management System
![Integration of All Transport Nodes of LEAs into a Transport Management System](../06_Application_Examples/images/00_Integration_Node.svg)

### 5.8.2 Transport Initiation
[Figure 5.19](#figure-519-initiation-of-a-push-transport-order) shows the transport initiation process.

##### Figure 5.19: Initiation of a Push Transport Order
![Initiation of a Push Transport Order](../06_Application_Examples/images/01_Transport_Initiierung.svg)
...
[Figure 5.20](#figure-520-travel-to-the-start-node) shows the process of traveling to the start node.

##### Figure 5.20: Travel to the Start Node
![Travel to the Start Node](../06_Application_Examples/images/02_Transport_Fahrt_Start.svg)
...
[Figure 5.21](#figure-521-coupling-the-transport-service-to-the-start-node) shows the process of coupling the Transport Service to the start node.

##### Figure 5.21: Coupling the Transport Service to the Start Node
![Coupling the Transport Service to the Start Node](../06_Application_Examples/images/03_Anbindung_Transportdienst.svg)
...
[Figure 5.22](#figure-522-loading-the-agv) shows the AGV loading process.

##### Figure 5.22: Loading the AGV
![Loading the AGV](../06_Application_Examples/images/04_Beladung_AGV.svg)
...
[Figure 5.23](#figure-523-travel-to-the-next-node-including-rerouting) shows the process of traveling to the next node, including the option of rerouting.

##### Figure 5.23: Travel to the Next Node Including Rerouting
![Travel to the Next Node Including Rerouting](../06_Application_Examples/images/05_Transport_Fahrt_NextNode_Rerouting.svg)
...
### 5.8.7 Processing
[Figure 5.24](#figure-524-processing-of-a-logistics-object) shows the process of handling an LO at a Processing node.

##### Figure 5.24: Processing of a Logistics Object
![Processing of a Logistics Object](../06_Application_Examples/images/06_Transport_Processing.svg)
...
[Figure 5.25](#figure-525-unloading-the-agv) shows the AGV unloading process.

##### Figure 5.25: Unloading the AGV
![Unloading the AGV](../06_Application_Examples/images/07_Entladung_AGV.svg)
