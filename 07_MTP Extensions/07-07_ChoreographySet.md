...
### 7.7.2 DataAssembly definitions
#### Specification of the System Unit Class UnionElement
*SUC UnionElement* ([Table 7.47](#table-747-dataassembly-definition-of-suc-unionelement)) is used to display the value of an *InputElement* or an *OutputElement*. Accordingly, a *UnionElement* interface is assigned to these model definitions via a LinkedObject relation.

##### Table 7.47: DataAssembly definition of *SUC UnionElement*
...
<table>
	...
	<tr><td colspan="6" align="left"><sup>a)</sup> Additional data types could be added to the <em>SUC UnionElement</em> in the future. All further interfaces that use the <em>SUC UnionElement</em> should therefore also allow extensions and not be <em>sealed</em>.</td></tr>
...
*SUC WritableUnionElement* ([Table 7.48](#table-748-dataassembly-definition-of-suc-writableunionelement)) is derived from *UnionElement* and is used to write a value into a *WritableInputElement*. Accordingly, a *WritableUnionElement* interface is always assigned to a *WritableInputElement* via a LinkedObject relation. 

##### Table 7.48: DataAssembly definition of *SUC WritableUnionElement*
...
*SUC ChoreographyElement* ([Table 7.49](#table-749-dataassembly-definition-of-suc-choreographyelement)) is an abstract class derived from *SUC DataAssembly* specified in [MTP Specification Part 3](../08_References/README.md#mtp-specification-part-3). The choreography-relevant DataAssembly definitions *ChoreographyParticipantManager* and *CommunicationManager* are derived from *ChoreographyElement*.

##### Table 7.49: DataAssembly definition of *SUC ChoreographyElement*
...
*SUC ChoreographyParticipantManager* ([Table 7.50](#table-750-dataassembly-definition-of-suc-choreographyparticipantmanager)) is derived from *SUC ChoreographyElement* and is used to configure the configurable logic of a choreography participant. In addition, it provides information for type, version, and instance verification of choreographed logistics lines, see also [Workflows](./07-01_Manifest.md#713-workflows). This DataAssembly definition is assigned to an *SUC ChoreographyParticipant* in the *ChoreographySet* via a LinkedObject relation.

##### Table 7.50: DataAssembly definition of *SUC ChoreographyParticipantManager*
...
<table>
	...
	<tr>
		...
		<td colspan="5" align="left">MTPDataAssemblySUCLib/DataAssembly/ChoreographyElement/CommunicationManager</td>
	</tr>
	<tr>
...
<table>
	...
	<tr><th align="left">AutomationML Path</th><td colspan="5" align="left">MTPDataAssemblySUCLib/DataAssembly/ChoreographyElement/CommunicationManager/&#7203;OpcUaClientServerManager</td></tr>
	...
	<tr><td align="left">Connection_SessionInfo_&#7203;SessionName</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">name of the session assigned by the client (when empty, then generated by the server)</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;ApplicationName</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">readable name of the OPC UA client application</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;SecurityMsgMode</td><td align="left">LOL ⟶ LEA</td><td align="left">UDINT</td><td align="left">enum UASecurityMsgMode</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;SecurityPolicy</td><td align="left">LOL ⟶ LEA</td><td align="left">UDINT</td><td align="left">enum UASecurityPolicy</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;ServerUri</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">defines the URI of the server, coded in ASCII</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;CheckServerCertificate</td><td align="left">LOL ⟶ LEA</td><td align="left">BOOL</td><td align="left">flag indicating if the server certificate should be checked</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;TransportProfile</td><td align="left">LOL ⟶ LEA</td><td align="left">UDINT</td><td align="left">enum UATransportProfile</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;UserIdentityTokenType</td><td align="left">LOL ⟶ LEA</td><td align="left">UDINT</td><td align="left">enum UAUserIdentityTokenType</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;UserTokenParam1</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">meaning according to UserIdentityTokenType, e.g., username</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;UserTokenParam2</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">meaning according to UserIdentityTokenType, e.g., password</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;CertificateID</td><td align="left">LOL ⟶ LEA</td><td align="left">UDINT</td><td align="left">certificate identifier</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;SessionTimeout</td><td align="left">LOL ⟶ LEA</td><td align="left">TIME</td><td align="left">timeout for the session in case of connection loss</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;MonitorConnection</td><td align="left">LOL ⟶ LEA</td><td align="left">TIME</td><td align="left">interval time to check the connection</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;LocaleID_1</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">optional language and regional identifier acc. to RFC 3066. 0 = no or unknown LocaleID.</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;LocaleID_2</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">optional language and regional identifier acc. to RFC 3066. 0 = no or unknown LocaleID.</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;LocaleID_3</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">optional language and regional identifier acc. to RFC 3066. 0 = no or unknown LocaleID.</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;LocaleID_4</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">optional language and regional identifier acc. to RFC 3066. 0 = no or unknown LocaleID.</td><td align="left">-</td><td align="left">-</td></tr>
	<tr><td align="left">Connection_SessionInfo_&#7203;LocaleID_5</td><td align="left">LOL ⟶ LEA</td><td align="left">STRING</td><td align="left">optional language and regional identifier acc. to RFC 3066. 0 = no or unknown LocaleID.</td><td align="left">-</td><td align="left">-</td></tr>
...
### 7.7.3 Model Definitions
#### Specification of the Instance Hierarchy Choreography
*IH Choreography* ([Table 7.53](#table-753-model-definition-of-ih-choreography)) is the entry point for the choreography-related information model in the instance hierarchy of an MTP.

##### Table 7.53: Model Definition of *IH Choreography*
...
<table>
	...
	<tr>
		<th align="left">Description</th>
		<td colspan="2" align="left">root element for the choreography-related information model of an MTP</td>
	</tr>
	<tr>
		<th align="left">Version</th>
...
*SUCL MTPChoreographySUCLib* ([Table 7.54](#table-754-library-definition-of-sucl-mtpchoreographysuclib)) contains the System Unit Classes of the *ChoreographySet* of a Module Type Package.

##### Table 7.54: Library Definition of *SUCL MTPChoreographySUCLib*
...
The *SUC ChoreographySet* ([Table 7.55](#table-755-model-definition-of-suc-choreographyset)), as a new aspect set of the MTP specification, is derived from *SUC MTPSet* according to [MTP Specification Part 1](../08_References/README.md#mtp-specification-part-1) and organizes all model definitions required to describe a LEA as a participant in a choreography.


##### Table 7.55: Model Definition of *SUC ChoreographySet*
...
<table>
	...
	<tr>
		<th align="left">Allowed Children</th>
		<td colspan="3" align="left">[1] EI of IC AspectSetReference which refers via ID to an IH </br>  containing [1] IE of SUC ChoreographyParticipant</td>
	</tr>
</table>

#### Specification of the System Unit Class ChoreographyParticipant
*SUC ChoreographyParticipant* ([Table 7.56](#table-756-model-definition-of-suc-choreographyparticipant)) describes a LEA as a choreography participant. The DataAssembly definition *SUC ChoreographyParticipantManager* is assigned to this model definition via a LinkedObject relation.

##### Table 7.56: Model Definition of *SUC ChoreographyParticipant*
...
<table>
	...
	<tr>
		<th align="left">Allowed Parents</th>
		<td colspan="3" align="left">IH to which an IE of SUC ChoreographySet relates via EI of IC AspectSetReference</td>
	</tr>
	<tr>
		<th align="left">Allowed Children</th>
...
*SUC InputList* ([Table 7.57](#table-757-model-definition-of-suc-inputlist)) organizes all incoming system variables relevant to the configurable logic of a choreography participant. The MTP of a choreography participant always contains exactly one *InputList*.

##### Table 7.57: Model Definition of *SUC InputList*
...
*SUC OutputList* ([Table 7.62](#table-762-model-definition-of-suc-outputlist)) organizes all outgoing system variables relevant to the configurable logic of a choreography participant. The MTP of a choreography participant always contains exactly one *OutputList*.

##### Table 7.62: Model Definition of *SUC OutputList*
...
*SUC FixedOutputElement* ([Table 7.64](#table-764-model-definition-of-suc-fixedoutputelement)) is derived from *SUC OutputElement* and describes a statically defined outgoing system variable provided by the internal program of the choreography participant.

##### Table 7.64: Model Definition of *SUC FixedOutputElement*
