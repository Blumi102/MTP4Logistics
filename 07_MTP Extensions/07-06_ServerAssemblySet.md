[< Previous](07-05_ProcessValueSet.md) | [Home](../README.md) | [Next >](07-07_ChoreographySet.md)

## 7.6 MTP Extension of the ServerAssemblySet
This chapter specifies all identified extensions of the *ServerAssemblySet* and integrates them into the existing [[MTP Specification Part 5]](../08_References/README.md#mtp-specification-part-5) and [[MTP Specification Part 5.1]](../08_References/README.md#mtp-specification-part-51), respectively.

#### Mapping Complex Data Types in OPC UA
The specification chapters [MTP Extension of the DataAssemblySet](./07-03_DataAssemblySet.md#73-mtp-extension-of-the-dataassemblyset), [MTP Extension of the ServiceSet](./07-04_ServiceSet.md#74-mtp-extension-of-the-serviceset), and [MTP Extension of the ProcessValueSet](./07-05_ProcessValueSet.md#75-mtp-extension-of-the-processvalueset) described DataAssembly definitions with complex data types for Structs and Arrays. To transmit these data types via OPC UA, not only the existing primitive data types but also the mapping of complex data types into the address space of the OPC UA server of a LEA must be specified.
