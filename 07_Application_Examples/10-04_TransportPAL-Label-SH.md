## 10.4 Application Example: Transport PAL–Label–SH
To illustrate the transport concepts described in the dissertation for logistics area automation, this section presents an exemplary application of the transport concept. A push transport from the PAL to SH1 is used as the example; however, a labeling LEA (LABEL) with a Processing node is additionally to be visited along the way. [Figure 10.12](#figure-1012-example-of-a-push-transport-from-a-palletizer-via-a-labeling-unit-to-a-stretch-hood-machine) shows the LEAs and their transport nodes.

##### Figure 10.12: Example of a Push Transport from a Palletizer via a Labeling Unit to a Stretch Hood Machine
...
### 10.4.1 0) LEA Integration
As the basis for carrying out the transport process, the MTPs of the three LEAs are imported into the transport management, *Transport Proxies* are generated, and these are connected to the LEA transport nodes. [Figure 10.13](#figure-1013-integration-of-leas-into-a-transport-management-system) shows the process of integrating the three LEAs; [Figure 10.14](#figure-1014-integration-of-all-transport-nodes-of-leas-into-a-transport-management-system) shows the process of integrating all transport nodes available in the LEAs.[^1]

##### Figure 10.13: Integration of LEAs into a Transport Management System
![Integration of LEAs into a Transport Management System](./images/Integration_LEA.png)

##### Figure 10.14: Integration of All Transport Nodes of LEAs into a Transport Management System
![Integration of All Transport Nodes of LEAs into a Transport Management System](./images/Integration_Node.png)

### 10.4.2 1) Transport Initiation
[Figure 10.15](#figure-1015-initiation-of-a-push-transport-order) shows the transport initiation process.

##### Figure 10.15: Initiation of a Push Transport Order
...
### 10.4.3 2) Travel to the Start Node
[Figure 10.16](#figure-1016-travel-to-the-start-node) shows the process of traveling to the start node.

##### Figure 10.16: Travel to the Start Node
...
### 10.4.4 3) Coupling the Transport Service to the Start Node
[Figure 10.17](#figure-1017-coupling-the-transport-service-to-the-start-node) shows the process of coupling the transport service to the start node.

##### Figure 10.17: Coupling the Transport Service to the Start Node
...
### 10.4.5 4) Loading the AGV
[Figure 10.18](#figure-1018-loading-the-agv) shows the AGV loading process.

##### Figure 10.18: Loading the AGV
...
### 10.4.6 5) Travel to the Next Node Including Rerouting
[Figure 10.19](#figure-1019-travel-to-the-next-node-including-rerouting) shows the process of traveling to the next node, including the option of rerouting.

##### Figure 10.19: Travel to the Next Node Including Rerouting
