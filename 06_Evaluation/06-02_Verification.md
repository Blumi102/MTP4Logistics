...
This section verifies the three artifacts against the automation requirements defined in [Section 2.6](../02_Modular_Logistics_System/02_Modular_Logistics_System.md#26-automation-requirements). For each requirement, the corresponding concept and its demonstration in the evaluation examples are referenced.
...
<table>
  ...
  <tr>
    ...
    <td align="left">LEA-specific operator displays support static identification images, dynamic service control elements, and variables with complex data types (<a href="../03_Logistics_Equipment_Assemblies/03-06_Operator_Displays.md">Section 3.6</a>).</td>
...
<table>
  ...
  <tr>
    ...
    <td align="left">LEAs within a Logistics Line are coordinated via a distributed choreography with configurable behavioral rules for procedure, parameter, process value, interlock, and constraint relations (<a href="../04_Logistics_Line/04-02_Horizontal_Integration.md">Section 4.2</a>).</td>
