...
(1) **DataAssembly definitions:** For all types of information to be exchanged between the equipment to be integrated and other systems, uniform MTP-based DataAssembly definitions must be specified.
