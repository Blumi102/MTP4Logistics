...
- **Individual parameters:** This mechanism corresponds to existing MTP parameterization. The *DIntServParam*, *AnaServParam*, *BinServParam*, and *StringServParam* interfaces from [[MTP Part 4]](../08_References/README.md#mtp-specification-part-4) are directly applicable; no extension is required.
...
- **LOL-initiated:** The LOL writes parameters to the LEA directly. This corresponds to existing MTP behavior [[MTP Part 4]](../08_References/README.md#mtp-specification-part-4); no extension is required.
